    ...
    <div className="relative flex-col lg:h-[55vh] md:h-[50vh] h-[40rem] flex ">
      ...
      <div className="relative flex flex-col p-4 h-full w-full ">
        <div className="flex items-center justify-center w-full ">
          <div className="bg-creme p-4 h-[12vh] lg:w-[60%] lg:text-3xl md:w-full md:text-3xl text-xl flex items-center justify-center relative top-5 md:top-">
        ...
        >
          ...
          >
            <div className="bg-white opacity-70 flex w-[80vw] max-w-[30rem] md:h-[12vh] md:max-w-[20rem] items-center justify-center p-2 mx-auto">
            ...
            <div className="bg-white opacity-70 flex w-[80vw] max-w-[30rem] md:max-w-[20rem] md:h-[12vh] items-center justify-center p-2 mx-auto">
              <div className="text-2xl font-thin flex items-center justify-center min-w-[2em]">
                2
              </div>
              <div className="flex justify-center items-center font-extralight text-sm p-4 min-w-[5em] max-w-[20rem]">
          ...
          >
            ...
            <div className="bg-white opacity-80 flex w-[80vw] max-w-[30rem] md:max-w-[20rem] md:h-[12vh] items-center justify-center p-2 mx-auto">
              <div className="text-2xl font-thin flex items-center justify-center min-w-[2em]">
                4
              </div>
